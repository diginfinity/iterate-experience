...
import ETSlotComponent from '@utils/SlotComponent'

describe('ETSlotComponent', () => {
    const MockComponent = {
    ...
    it('is called', () => {
        const wrapper = shallowMount(ETSlotComponent, {
            propsData: {
                component: {}
            }
        })

        expect(wrapper.name()).toBe('ETSlotComponent')
