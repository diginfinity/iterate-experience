...
import EtAutocomplete from '@components/autocomplete/Autocomplete'
...
describe('EtAutocomplete', () => {
    beforeEach(() => {
        wrapper = mount(EtAutocomplete)
    ...
    it('is called', () => {
        expect(wrapper.name()).toBe('EtAutocomplete')
