<template>
    <span class="et-icon" :class="[newType, size]">
        <i
    ...
    export default {
        ...
        computed: {
            ...
            newType() {
                ...
                return `et-has-text-${splitType[1]}`
            },
            newCustomSize() {
            ...
            customSizeByPack() {
                ...
                const largeSize = this.newPack === 'mdi'
                    ...
                    : this.addFAPrefix('3x')
                switch (this.size) {
                    case 'et-is-small': return
                    case 'et-is-medium': return mediumSize
                    case 'et-is-large': return largeSize
